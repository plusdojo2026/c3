	...
	<div class="container">
		...
		<div class="right">
			...
			<div id="loginForm">
				...
				<label><span class="required">ID</span></label> <input type="text"
					id="loginId"> <label><span class="required">パスワード</span></label>
			...
			<div id="registerForm" style="display: none;">
				...
				<label><span class="required">ID</span></label> <input type="text"
					id="registId"> <label><span class="required">パスワード</span></label>
